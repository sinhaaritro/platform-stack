...
*   [ ] **Remove manually configured Cloudflare** — remove all the unessary manual config of cloudflare.
*   [ ] **Add Cloudflare** — Add in opentofu to control the dns, nameservers to cloudflare.
*   [ ] **LXC** — Add the adguard as LXC from netbird.
...
*   [ ] **Doc cleaning** — Consolidate docs under folder.
*   [ ] ...
